...
import random
import sys, os
sys.path.append("/data/yinghaoliu/GLA-dLLM")
from BiDeltaDiff.models import BiDeltaDiffConfig,BiDeltaDiffForCausalLM

#sys.path.append("/data/yinghaoliu/GLA-dLLM/BiDeltaDiff/models")
model_name = "/data/yinghaoliu/GLA-dLLM/trained_models/finetune_fast_dLLM_v2_1.5B_BGDN/checkpoint-1800"
AutoModelForCausalLM.register(BiDeltaDiffConfig, BiDeltaDiffForCausalLM)

AutoConfig.register("BiDeltaDiff", BiDeltaDiffConfig)
